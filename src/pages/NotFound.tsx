...
export default function NotFound() {
  return (
    <motion.div
      ...
      style={{ background: 'var(--nova-surface-warm)' }}
    >
      <div className="text-center">
        <NovaSyncLogo size={48} className="mx-auto mb-6" />
        <h1 className="text-7xl font-extrabold mb-4" style={{ color: 'var(--nova-text-muted)' }}>404</h1>
        <p className="text-lg font-medium mb-6" style={{ color: 'var(--nova-text-secondary)' }}>Page Not Found</p>
        <Link
          to="/"
